...
exports.specifics = (req, res) => {
    ...
    var response = {
        ...
        "rsp_msg": "success", //success: 성공, unauthorized_token: 유효하지않은 접근토큰 fail: 실패
        "search_timestamp": YYYYMMDD(new Date().getTime()), //YYYYMMDDHHMM
        "IDV_ID": "1234123", // 10자리 숫자
        "AGE_GROUP": "6", // 수진자연령(두자리 정수)
        "SEX": "성별구분코드(// 1: 남자, 2: 여자, 9: 구분오류)",
        ...
        "hospitaCL_CDl_type_code": "11", // 01: 상급종합병원, 11: 종합병원, 21: 병원, 28: 요양병원, 29: 정신병원, 31: 의원, 41: 치과병원, 51: 치과의원, 61: 조산원, 71: 보건소, 72: 보건지소, 73: 보건진료소, 74: 모자보건센타, 75: 보건의료원, 81: 약국, 91: 한방종합병원, 92: 한방병원, 93: 한의원, 94: 한약방
        "MAIN_SICK": "S96", // 주상병코드
        "SUB_SICK": ' S93', // 부상병코드
        "DSBJT_CD": "진료과목코드", // 00: 일반의, 01: 내과, 02: 신경과, 03: 정신건강의학과, 04: 외과, 05: 정형외과, 06: 신경외과, 07: 흉부외과, 08: 성형외과, 09: 마취통증의학과, 10: 산부인과, 11: 소아청소년과, 12: 안과, 13: 이비인후과, 14: 피부과, 15: 비뇨의학과, 16: 영상의학과, 17: 방사선종양학과, 18: 병리과, 19: 진단검사의학과, 20: 결핵과, 21: 재활의학과, 22: 핵의학과, 23: 가정의학과, 24: 응급의학과, 25: 직업환경의학과, 26: 예방의학과, 27: 기타1(치과), 28: 기타4(한방), 31: 기타2, 40: 기타2, 41: 보건, 42: 기타3, 43: 보건기관치과, 44: 보건기관한방, 49: 치과, 50: 구강악안면외과, 51: 치과보철과, 52: 치과교정과, 53: 소아치과, 54: 치주과, 55: 치과보존과, 56: 구강내과, 57: 영상치의학과, 58: 구강병리과, 59: 예방치과, 60: 치과소계, 61: 통합치의학과, 80: 한방내과, 81: 한방부인과
        "PRCL_SYM_TP_CD": "특정기호구분코드", // https://m.blog.naver.com/ashlee78/221358295810
        "INJ_EXA_TP_CD": "상해외인구분코드", // https://blog.naver.com/39954/222059621563
        "OINJ_TP_CD": "공상구분코드", // 0: 정상건, 1: 공상건(공교공단), 3: 보훈감면30%(광주민주유공자)
        "DGRSLT_TP_CD": "진료결과구분코드", // 1: 계속, 2: 이송, 3: 회송, 4: 사망, 5: 기타, 9: 퇴원
        "RECU_FR_DT": "요양개시일자", // YYYYMMDD
        "RECN": "내원일수", // 다섯자리 정수
        "DMD_YPAY_XPNS_TOT_AMT": "청구요양급여비용총금액" // 스무자리 정수
    }
    checkAndAPICall(res,info,response);
}
