...
/**
   * @path {GET} http://mypd.kr/v1/pharmacy/lists
...
/**
   * @path {POST} http://mypd.kr/v1/pharmacy/histories
...
/**
   * @path {GET} http://mypd.kr/v1/pharmacy/apis
...
/**
    * @path {GET} http://mypd.kr/v1/pharmacy/consents
    * @description API 목록 조회
    */
